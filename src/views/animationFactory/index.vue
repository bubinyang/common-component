<template>
  <section class="animation-style">

<svg >
    <!-- style="stroke-dashoffset:50" -->
　　<line  id="line" x1="30" y1="30" x2="300" y2="30" stroke-width="20" stroke="red" stroke-dasharray="50,20,10"/>
</svg>
            ...
            // }
             ...
             .line1 {
                ...
                .line2 {
                    stroke-dasharray: 320;
                    stroke-dashoffset: 320;
                   animation: dash2 1.5s linear alternate 1;
                }
