    ...
    pull(options) {
      ...
      moveEl.addEventListener('mousedown', function(e) {
        ...
        move = function(event) {
          ...
          formerEl.style[typeDirection.styleKey] = `calc(${topPercentVal}% - ${topPercentVal == 100 || topPercentVal == 0 ? 10 : 5}px)`
          rearEl.style[typeDirection.styleKey] = `calc(${bottomPercentVal}% - ${bottomPercentVal == 100 || bottomPercentVal == 0 ? 10 : 5}px)`
