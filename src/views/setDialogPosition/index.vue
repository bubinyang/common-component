<template>
    <div class="setDialogPosition-style">
        <div ref="clickRef" class="item-contain"></div>
        <div class="item-content" :style="positionStyle"></div>

        <svg id="svgEl" width="100%" height="100%" version="1.1">

         <polygon name="厂房1" points="210,80 238,72 260,90 230,100" style="fill:transparent; stroke:#000000;stroke-width:1"/>
                    
                     <polygon  name="厂房2"  points="210,150 238,142 260,160 230,170" style="fill:transparent; stroke:#000000;stroke-width:1"/>
           ...
           const contentEl=document.querySelector('.item-content')
            this.$refs['clickRef'].addEventListener('click',function(e){
              positionAttr.forEach(item=>{
                ...
                const position=newSetDialogPosition('.setDialogPosition-style',{eventItem:e,dialogElName:'.item-content'})
